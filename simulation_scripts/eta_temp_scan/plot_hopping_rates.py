...
# plt.savefig('/Users/jeremywilkinson/research/gle/drafts/coloured_noise/images/md_vs_gle_gamma.pdf')
plt.show()
print()
...
# plt.savefig('/Users/jeremywilkinson/research/gle/drafts/coloured_noise/images/md_temp_vs_eta.pdf')
plt.show()
